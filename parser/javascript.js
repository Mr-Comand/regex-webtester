...
import Snap from '../modules/snap.svg.js';
import _ from '../modules/lodash.js';
...
export default class Parser {
  ...
  set container(cont) {
    ...
    this._container.innerHTML = [
      document.querySelector('#renderedRegexContainer').innerHTML,
    ...
    return this.parsed.render(svg.group())
      ...
      .then(result => {
        ...
        svg.attr({
          ...
          viewBox: `0 0 ${box.width + 20} ${box.height + 20}`
        });
      })
